...
return [
    ...
    */
    ...
    'options' => [
        ...
        'repository' => 'https://github.com/pacski/new-laravel.git',
    ...
    */
    ...
    'hosts' => [
        'https://laetitcreation-pacski.herokuapp.com' => [
            'deploy_path' => '/var/www/https://laetitcreation-pacski.herokuapp.com',
            'user' => 'root',
        ],
    ],
